...
const controlDeleteRecipe = async function() {
    try {
        ...
        console.error(err);
        (0, _recipeViewJsDefault.default).renderError('Failed to delete recipe.');
    }
};
const init = function() {
...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}${id}?key=${(0, _configJs.KEY)}`, 'GET');
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?search=${query}&key=${(0, _configJs.KEY)}`, 'GET');
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?key=${(0, _configJs.KEY)}`, 'POST', recipe);
        state.recipe = createRecipeObject(data);
...
const deleteRecipe = async function(id) {
    try {
        // Delete from API
        await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}${id}?key=${(0, _configJs.KEY)}`, 'DELETE');
        // Delete Recipe
...
const KEY = '9806fadb-444e-4747-8a8e-a26c3d6d57c7';
const MODAL_CLOSE_SEC = 2.6;
...
const AJAX = async function(url, method = 'GET', uploadData) {
    try {
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        <div class="recipe__details">
          ...
          <button style="color:white; margin-left: 1rem" class="btn--round ${this._data.key ? '' : 'hidden'} delete ">
            Delete
          </button>
        </div>
...
},{"url:../../img/icons.svg":"fd0vu","fracty":"gsPKI","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
},{"regenerator-runtime":"f6ot0","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kbE4Z":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"./previewView":"6tKHS","./View":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (this.curPage === 1 && numPages > 1) return `${this._generateNextButton()}`;
        // last page
        if (this.curPage === numPages && numPages > 1) return `${this._generatePreviousButton()}`;
        // other page
        if (this.curPage < numPages) return `${this._generateNextButton()}${this._generatePreviousButton()}`;
        // page 1, and there are no other pages
        return '';
    }
    _generateNextButton() {
        return `
      <button data-goto="${this.curPage + 1}" class="btn--inline pagination__btn--next">
    ...
    _generatePreviousButton() {
        return `
      <button data-goto="${this.curPage - 1}" class="btn--inline pagination__btn--prev">
        <svg class="search__icon">
...
class BookmarksView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        return this._data.map((bookmarks)=>(0, _previewViewDefault.default).render(bookmarks, false)).join('');
    }
}
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _successMessage = 'Recipe is successfully uploaded';
    ...
    toggleWindow() {
        ...
        if (!this._overlay.classList.contains('hidden')) this._restoreOriginalForm();
    }
